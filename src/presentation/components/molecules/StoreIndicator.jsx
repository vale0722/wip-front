...
export default function StoreIndicator({ setIsLoading, refresh }) {
  ...
  const storeIndicator = () => {
    services.indicators
      ...
      .then(() => {
        setDescription(null);
        setType(null);
        document.getElementsByName('description-indicator').item(0).value =
          null;
        refresh();
      });
  };
