        ...
        <div className='flex flex-col h-full w-full gap-2'>
          <div className='flex flex-col gap-2 mb-6 justify-center items-center'>
            ...
            <span className='text-sm text-gray-300'>
              Estás apunto de eliminar un area integrada, si lo haces perderás
              toda la información relacionada al area integrada como planes de
              clase, asignaturas y seguimientos.
            </span>
          </div>
