...
export default function DeleteCompetence({
  setIsLoading,
  competenceActive,
  setCompetenceActive,
  refresh,
  ...
  const deleteCompetence = () => {
    services.competences.remove(setIsLoading, competenceActive.key).then(() => {
      setCompetenceActive({});
      refresh();
    });
  };
        ...
        <div className='flex flex-col h-full w-full gap-2'>
          <div className='flex flex-col gap-2 mb-6 justify-center items-center'>
            ...
            <span className='text-sm text-gray-300'>
              Estás apunto de eliminar la competencia: {competenceActive.label}
            </span>
          </div>
