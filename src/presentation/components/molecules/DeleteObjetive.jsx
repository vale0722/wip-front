...
export default function DeleteObjetive({
  setIsLoading,
  objetiveActive,
  setObjetiveActive,
  refresh,
}) {
  const deleteObjetive = () => {
    services.objetives.remove(setIsLoading, objetiveActive.key).then(() => {
      setObjetiveActive({});
      refresh();
    });
  };
        ...
        <div className='flex flex-col h-full w-full gap-2'>
          <div className='flex flex-col gap-2 mb-6 justify-center items-center'>
            ...
            <span className='text-sm text-gray-300'>
              Estás apunto de eliminar el objetivo: {objetiveActive.label}
            </span>
          </div>
