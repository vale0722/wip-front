...
export default function DeleteIndicator({
  ...
  const deleteIndicator = () => {
    services.indicators.remove(setIsLoading, indicatorActive.key).then(() => {
      setIndicatorActive({});
      refresh();
    });
  };
        ...
        <div className='flex flex-col h-full w-full gap-2'>
          <div className='flex flex-col gap-2 mb-6 justify-center items-center'>
            ...
            <span className='text-sm text-gray-300'>
              Estás apunto de eliminar el indicador de desempeño:
              {indicatorActive.label}
            </span>
          </div>
