...
export default function StoreCompetence({ setIsLoading, refresh }) {
  const { subject: subjectId } = useParams();
  const [description, setDescription] = useState();

  const storeCompetence = () => {
    services.competences
      ...
      .then(() => {
        setDescription(null);
        document.getElementsByName('description-competence').item(0).value =
          null;
        refresh();
      });
  };
      ...
      <div className='modal-box relative gap-4 bg-white shadow p-8 rounded-lg flex flex-col items-start justify-between'>
        <div className='flex flex-col h-full w-full gap-2'>
          <div className='flex flex-col gap-2 mb-6 justify-center items-center'>
            <span className='text-xl font-semibold'>Crear Competencia</span>
