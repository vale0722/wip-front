...
export default function EditCompetence({
  ...
  const editCompetence = () => {
    services.competences
      .update(setIsLoading, competenceActive.key, {
        description,
      })
      .then(() => {
        setCompetenceActive({});
      ...
      <div className='modal-box relative gap-4 bg-white shadow p-8 rounded-lg flex flex-col items-start justify-between'>
        <div className='flex flex-col h-full w-full gap-2'>
          <div className='flex flex-col gap-2 mb-6 justify-center items-center'>
            <span className='text-xl font-semibold'>Editar Competencia</span>
            ...
            <div className='flex flex-col gap-2 w-full'>
              ...
              <textarea
                ...
                defaultValue={competenceActive.label}
