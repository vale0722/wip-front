...
export default function EditObjetive({
  setIsLoading,
  objetiveActive,
  setObjetiveActive,
  refresh,
  ...
  const editObjetive = () => {
    services.objetives
      .update(setIsLoading, objetiveActive.key, {
        description,
      })
      .then(() => {
        setObjetiveActive({});
      ...
      <div className='modal-box relative gap-4 bg-white shadow p-8 rounded-lg flex flex-col items-start justify-between'>
        <div className='flex flex-col h-full w-full gap-2'>
          <div className='flex flex-col gap-2 mb-6 justify-center items-center'>
            <span className='text-xl font-semibold'>Editar Objetivo</span>
            ...
            <div className='flex flex-col gap-2 w-full'>
              ...
              <textarea
                ...
                defaultValue={objetiveActive.label}
                className='block form-input !p-2'
              >
                {objetiveActive.label}
              </textarea>
            </div>
          </div>
