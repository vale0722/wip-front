...
export default function AreaShowPage({ setIsLoading }) {
  ...
  const [name, setName] = useState(areaActive.name);
  const dispatch = useDispatch();

  const updateArea = () => {
    services.area
      .update(setIsLoading, gradeId, areaId, {
        name,
      })
      .then(() => {
        services.area
  ...
  const deleteArea = () => {
    services.area.remove(setIsLoading, gradeId, areaId).then(() => {
      history.push(config.routes.grades.show.path.replace(':grade', gradeId));
    });
  };
                ...
                <img
                  ...
                  src={
                    ...
                    `https://ui-avatars.com/api/?name=${
                      areaActive.name ? areaActive.name.replace(' ', '+') : ''
                    }`
                  }
                  alt={areaActive.name}
                />
                      ...
                      <div className='flex flex-col h-full w-full gap-2'>
                        <div className='flex flex-col gap-2 mb-6 justify-center items-center'>
                          <span className='text-xl font-semibold'>
                            ¿Realmente desea realizar esta acción?
                          </span>
                          <div className='h-32 w-32'>
                            ...
                            >
                              <path
                                id='a935b196-91fc-4d65-bd04-49275a33d175-77'
                                data-name='Path 1'
                              ...
                              />
                              <path
                                id='af9a6d89-7824-4af5-a475-6980c18ad0f3-78'
                                data-name='Path 2'
                              ...
                              />
                              <path
                                id='ae138407-70d7-43ff-b006-9d3240c337f6-79'
                                data-name='Path 3'
                              ...
                              />
                              <path
                                id='a7d931fe-d47e-4aa5-ae01-a0d26a3448cc-80'
                                data-name='Path 4'
                              ...
                              />
                              <path
                                id='b274f1e0-b558-44b1-a0b2-dcd77bbddb14-81'
                                data-name='Path 5'
                              ...
                              />
                              <path
                                id='bca7d782-7e31-494e-97b0-f49b8df7894d-82'
                                data-name='Path 8'
                              ...
                              />
                              <path
                                id='b31113e7-cae2-4653-b248-af5e4acb0a6c-83'
                                data-name='Path 10'
                              ...
                              >
                                <path
                                  id='bc369f15-2cd9-428d-9eec-3a8fd8cc1bba-84'
                                  data-name='Path 111'
                                ...
                                />
                                <path
                                  id='fafca8b8-1a63-4513-a3fa-e64917847011-85'
                                  data-name='Path 112'
                                ...
                                />
                                <path
                                  id='a38ea43e-f1b1-406e-84c8-61e7480f01b4-86'
                                  data-name='Path 113'
                                ...
                                />
                                <path
                                  id='b5ba90e2-8a51-4a77-95c4-5b486c8770ec-87'
                                  data-name='Path 114'
                                ...
                                />
                                <path
                                  id='b1536285-e66e-494f-8c4f-a2304265e4c3-88'
                                  data-name='Path 115'
                                ...
                                />
                                <path
                                  id='acd6249e-4699-4411-813c-091b3a750afe-89'
                                  data-name='Path 116'
                                ...
                                />
                                <path
                                  id='ece4d731-f277-435f-bbc1-e3b70679d22f-90'
                                  data-name='Path 117'
                                ...
                                />
                                <path
                                  id='b91f5bf0-a8c5-41a2-a26e-8e2fd84207c6-91'
                                  data-name='Path 118'
                                ...
                                />
                                <path
                                  id='b0b7866d-f3ba-460a-97cc-8103175b89de-92'
                                  data-name='Path 119'
                                ...
                                />
                                <path
                                  id='e83e2647-99b5-4c80-ac3e-9e5d1f9bc81d-93'
                                  data-name='Path 120'
                              ...
                              >
                                <path
                                  id='bc404282-8d4f-43f7-bc12-02f97785eba1-94'
                                  data-name='Path 81'
                                ...
                                />
                                <path
                                  id='ae4af9f3-88ec-4cab-9b9e-a4fc234f7062-95'
                                  data-name='Path 82'
                                ...
                                />
                                <path
                                  id='fe48f3fd-992f-41c2-af3b-c30882e26a16-96'
                                  data-name='Path 83'
                                ...
                                />
                                <path
                                  id='e216638f-22ba-49ea-a46c-300c78c4e875-97'
                                  data-name='Path 84'
                                ...
                                />
                                <path
                                  id='ee43e3d8-5f22-4b53-a964-043fec166479-98'
                                  data-name='Path 85'
                          ...
                          <span className='text-sm text-gray-300'>
                            Estás apunto de eliminar un area integrada, si lo
                            haces perderás toda la información relacionada al
                            area integrada como planes de clase, asignaturas y
                            seguimientos.
                          </span>
                        </div>
                        <div className='flex items-end justify-end'>
                          <button
                            type='button'
                            onClick={() => deleteArea()}
                            className='flex items-center py-2 px-4 rounded-lg text-sm bg-red-500 text-white shadow-lg'
                          >
                            Confirmar
                          </button>
                        </div>
